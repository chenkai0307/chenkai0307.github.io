...
![火影忍者小南铁丝网桌面壁纸](https://bizhi1.com/wp-content/uploads/2024/05/naruto-konan-barbed-wire-desktop-wallpaper-small.jpg)
...
![image-20230306164838564](https://oss.itbaima.cn/internal/markdown/2023/03/06/rRtxbFZXDkmGci4.png)

接着我们继续往下，到了` 0: invokestatic  #2                  // Method a:()I`时，需要调用方法`a()`，这时当前方法就不会继续向下运行了，而是去执行方法`a()`，那么同样的，将此方法也入栈，注意是放入到栈顶位置，`main`方法的栈帧会被压下去：

![image-20230306164848411](https://oss.itbaima.cn/internal/markdown/2023/03/06/SZJWH8l5xByTjr7.png)
...
![image-20230306164908882](https://oss.itbaima.cn/internal/markdown/2023/03/06/FBpxKWIbuY7ftq4.png)
...
![image-20230306165041598](https://oss.itbaima.cn/internal/markdown/2023/03/06/r5IsmTk3DZfXA26.png)
...
![image-20230306165105858](https://oss.itbaima.cn/internal/markdown/2023/03/06/C71bdyIY2JVpLKz.png)
...
![image-20230306165425918](https://oss.itbaima.cn/internal/markdown/2023/03/06/71PqlEfiGgBSLae.png)
